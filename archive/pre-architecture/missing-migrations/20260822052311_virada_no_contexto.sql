-- TMDay depende do locale do servidor e voltou "Thursday". Dia da semana
-- em portugues, sem depender de lc_time.
...
-- A virada e a procura entram no contexto oficial. 'procura' vai junto de
