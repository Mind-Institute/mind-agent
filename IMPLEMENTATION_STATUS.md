...
busca antes da abstinência do Concierge. A migration
`concierge_livros_autografos` também foi aplicada: o novo chunk está pesquisável
por léxico e pendente apenas da geração assíncrona do embedding.
