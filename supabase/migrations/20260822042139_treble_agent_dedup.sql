...
-- mensagem chegou 2x em ~2s). Sem isso o bot responde em dobro e repete
-- perguntas. Se a mesma fala já foi respondida há poucos segundos,
-- devolvemos a resposta anterior em vez de gerar outra.
