...
comment on table mind.origens is
  'Botoes de entrada por site. Fonte unica do utm_source, do campo oculto do HubSpot e da mensagem de abertura do bot.';
...
language sql security definer set search_path = public, mind
as $fn$ select public.mind_materiais_para('whatsapp_treble', p_audience, null, p_origem) $fn$;
