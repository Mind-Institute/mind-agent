-- A Adriana pediu para registrar o NOME de cada material ja mencionado e
-- deixar o resto em branco, para nao esquecermos de preencher.
-- Entram desligados (ativo = false): material sem link nao pode ser
-- oferecido, e mind_materiais_para so enxerga os ativos.
...
comment on column mind.materiais.status is
  'pendente = cadastrado so com o nome, aguardando link/transcricao/ICP. Nunca fica ativo enquanto estiver pendente.';
...
('tour_3d', 'Tour 3D do evento', 'video', null, null,
 'Mostra como o evento foi redesenhado. Quebra desconfianca de quem teve experiencia ruim na edicao passada.',
 'pendente', false, array['b2c','b2b','desconhecido'], 10),

('video_evento_curto', 'Video curto sobre o evento', 'video', null, null,
...
('video_descadastro', 'Video rapido — mensagem de descadastro', 'video',
 'https://youtube.com/shorts/F283ezhqfJY', null,
 'Ja tem link. Vai na mensagem de descadastro, sem tentar reverter.',
 'pendente', false, array['b2c','b2b','desconhecido'], 30),

('apresentacao_b2b', 'Apresentacao B2B (PDF)', 'pdf', null, null,
 'Municao para quem precisa da aprovacao do diretor: manda antes de a pessoa sumir.',
 'pendente', false, array['b2b'], 40),

('pdf_delegacoes', 'PDF de ingressos para delegacoes', 'pdf', null, null,
 'E o mesmo material que a pessoa baixa no site pelo botao delegacoes_pdf.',
 'pendente', false, array['b2b'], 50),

('pdf_programacao', 'PDF da programacao', 'pdf', null, null,
 'Mesmo material do botao programacao_pdf do site.',
 'pendente', false, array['b2c','b2b','ja_comprou','desconhecido'], 60),

('site_b2b', 'Site mindsummit.company (oferta B2B)', 'pagina', null, null,
 'Onde a oferta B2B esta desenhada. Precisa entrar na base de conhecimento tambem, nao so como link.',
 'pendente', false, array['b2b'], 70),

('calculadora_grupo', 'Calculadora de desconto por grupo', 'pagina', null, null,
 'Existe, mas mandar para o lead brincar sozinho e too much (Adriana). O bot monta a conta; a calculadora e para o time.',
 'pendente', false, array['b2b'], 80),

('depoimentos', 'Depoimentos em video', 'depoimento', null, null,
 'Precisa de um registro POR depoimento, com transcricao, ICP que atende e as dores que ele nomeia — sem isso nao da para escolher o certo para cada lead.',
 'pendente', false, array['b2c','b2b','desconhecido'], 90),

('videos_baixa_definicao', 'Pasta de videos em baixa definicao (Drive)', 'outro', null, null,
 'Acervo bruto no Drive. Link de pasta do Drive nao serve para mandar a lead: precisa do video final publicado.',
