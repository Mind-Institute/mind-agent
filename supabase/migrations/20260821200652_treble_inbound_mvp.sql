...
-- Reusa o que o schema mind já tem (offers = ingressos, policies,
-- event_rules, organization_content = FAQ); cria só o que falta.
...
-- não oferece benefício. Valores reais entram com os dados da Adriana.
