-- Botoes de entrada do site, do documento "Mensagens site summit 2"
-- (Adriana, 2026-08-22). O doc previa "direcionar bot B2B" / "bot roteador"
-- / "bot atendimento": com o cerebro unico isso deixa de ser roteamento
-- entre bots e vira audiencia_sugerida na origem.
--
-- Sao dois campos ocultos por botao, entao hubspot vira jsonb.
...
comment on column mind.origens.hubspot is
  'Campos ocultos do formulario do HubSpot para este botao: {propriedade: valor}. perfil_d_cliente ja existe no portal; a propriedade de Intencao ainda precisa ser confirmada ou criada.';
...
('delegacoes_condicoes_wpp', 'mindsummit',
 ...
 'b2b',
 '{"perfil_d_cliente": "B2B", "intencao": "Whatsapp"}'::jsonb,
...
('delegacoes_pdf', 'mindsummit',
 ...
 'b2b',
 '{"perfil_d_cliente": "B2B", "intencao": "Informações"}'::jsonb,
 'Oi, {nome}! Tudo bem? Aqui é o assistente do Mind Summit.
...
('programacao_pdf', 'mindsummit',
 ...
 'desconhecido',
 '{"perfil_d_cliente": "Não sei", "intencao": "Informações"}'::jsonb,
 'Oi, {nome}, tudo bem? Aqui é o assistente do Mind Summit.
...
('whatsapp_flutuante', 'mindsummit',
 ...
 'desconhecido',
 '{"perfil_d_cliente": "Não sei", "intencao": "Whatsapp"}'::jsonb,
...
-- mind_origem passa a devolver os dois campos ocultos e as mensagens.
