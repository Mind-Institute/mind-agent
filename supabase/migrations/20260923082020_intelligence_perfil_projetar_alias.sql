-- perfil_projetar: o alias "r" da tabela colidia com a variável plpgsql "r record"
-- (ERROR 55000 record "r" is not assigned yet). Alias das consultas de cargo/empresa vira "ry".
